...
; RUN: llc -mtriple=riscv32 -mattr=bt -verify-machineinstrs < %s \
; RUN:   | FileCheck %s -check-prefix=RV32IB

define i32 @_cmix(i32 %a, i32 %b, i32 %c) nounwind {
...
define i32 @_cmov(i32 %a, i32 %b, i32 %c) nounwind {
...
define i32 @_fshl(i32 %a, i32 %b, i32 %c) nounwind {
...
define i32 @_fshr(i32 %a, i32 %b, i32 %c) nounwind {
