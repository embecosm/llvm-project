...
; RUN: llc -mtriple=riscv64 -mattr=bp -verify-machineinstrs < %s \
; RUN:   | FileCheck %s -check-prefix=RV64IB

define i64 @_grev1(i64 %a) nounwind {
...
define i64 @_grev2(i64 %a) nounwind {
...
define i64 @_grev4(i64 %a) nounwind {
...
define i64 @_grev8(i64 %a) nounwind {
...
define i64 @_grev16(i64 %a) nounwind {
; RV64I-NOT:    rev16.w a0, a0
;
; RV64IB-LABEL: _grev16:
; RV64IB:       # %bb.0:
...
define i64 @_grev32(i64 %a) nounwind {
; RV64I-NOT:    rev32 a0, a0
;
; RV64IB-LABEL: _grev32:
; RV64IB:       # %bb.0:
...
define i64 @_bswap_i64(i64 %a) {
; RV64I-NOT:    rev8 a0, a0
;
; RV64IB-LABEL: _bswap_i64:
; RV64IB:       # %bb.0:
...
define i64 @_bitreverse_i64(i64 %a) nounwind {
; RV64IB-NOT:    rev a0, a0
;
; RV64IB-LABEL: _bitreverse_i64:
; RV64IB:       # %bb.0:
...
define i64 @_gorc1(i64 %a) nounwind {
...
define i64 @_gorc2(i64 %a) nounwind {
...
define i64 @_gorc4(i64 %a) nounwind {
...
define i64 @_gorc8(i64 %a) nounwind {
...
define i64 @_gorc16(i64 %a) nounwind {
; RV64I-NOT:    orc16.w a0, a0
;
; RV64IB-LABEL: _gorc16:
; RV64IB:       # %bb.0:
...
define i64 @_gorc32(i64 %a) nounwind {
; RV64I-NOT:    orc32 a0, a0
;
; RV64IB-LABEL: _gorc32:
; RV64IB:       # %bb.0:
...
define i64 @_shfl1(i64 %a, i64 %b) nounwind {
...
define i64 @_shfl2(i64 %a, i64 %b) nounwind {
...
define i64 @_shfl4(i64 %a, i64 %b) nounwind {
...
define i64 @_shfl8(i64 %a, i64 %b) nounwind {
...
define i64 @_shfl16(i64 %a, i64 %b) nounwind {
; RV64I-NOT:    zip16 a0, a0
;
; RV64IB-LABEL: _shfl16:
; RV64IB:       # %bb.0:
